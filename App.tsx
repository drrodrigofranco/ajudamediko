...
const App: React.FC = () => {
    ...
    useSEO({
        ...
        description: 'Ultrassom em Nova Andradina - MS: Morfológico, Obstétrico com Doppler e 3D, Abdominal, Tireoide, Mama, Próstata, Vascular e outros exames. Clínica Franco. Agende pelo WhatsApp: (67) 99844-6674.',
        path: '/',
    ...
    return (
        <div className="flex flex-col min-h-screen bg-white font-sans text-gray-800">
            ...
            <a href="https://wa.me/5567998446674" target="_blank" className="fixed bottom-8 left-8 z-50 bg-[#25D366] text-white p-5 rounded-full shadow-2xl hover:scale-110 transition-all duration-300">
