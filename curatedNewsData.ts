...
export const curatedNews: CuratedNewsItem[] = [
  {
    id: 'ms-fiocruz-genomica-doencas-raras-sus-2026',
    title: 'Ministério da Saúde e Fiocruz lançam curso nacional de genômica para ampliar o diagnóstico de doenças raras no SUS',
    summary: 'O Ministério da Saúde, em parceria com a Fiocruz, deu início em 3 de agosto a um curso nacional voltado à ampliação do acesso à medicina genômica dentro do Sistema Único de Saúde (SUS). A iniciativa, batizada de "Análise Genômica para o Diagnóstico de Doenças Raras Genéticas no SUS", tem carga horária de 160 horas e vai até fevereiro de 2027, combinando aulas síncronas e assíncronas em ambiente virtual de aprendizagem.\n\nO público-alvo são profissionais dos Serviços de Referência em Doenças Raras habilitados no SUS que contam com médicos geneticistas em atuação - ao todo, 70 participantes foram selecionados em processo realizado em julho. O conteúdo programático abrange desde conceitos fundamentais de doenças genéticas até genômica clínica e interpretação de exames, buscando fortalecer a capacidade da rede pública de oferecer diagnósticos de precisão.\n\nSegundo o Ministério da Saúde, cerca de 13 milhões de brasileiros convivem com alguma doença rara, e aproximadamente 70% dessas condições têm origem genética. O exame genômico é apontado como ferramenta central não só para o diagnóstico, mas também para o planejamento terapêutico e o aconselhamento familiar nesses casos - reforçando a importância de profissionais capacitados para interpretar esse tipo de exame em todo o país.',
    sourceName: 'Ministério da Saúde (gov.br)',
    sourceUrl: 'https://www.gov.br/saude/pt-br/assuntos/noticias-ms/2026/agosto/ministerio-da-saude-incia-curso-nacional-para-ampliar-o-diagnostico-de-doencas-raras-no-sus',
    publishedOn: '2026-08-16',
  },
  {
    id: 'fiocruz-aids-2026-conferencia-rio',
    title: 'Rio de Janeiro sedia pela primeira vez a Conferência Internacional de Aids, com foco em cura, prevenção e financiamento global',
    summary: 'O Rio de Janeiro recebeu, na primeira semana de agosto, a 26ª Conferência Internacional de Aids (Aids 2026), reunindo cerca de 7 mil participantes entre cientistas, lideranças de saúde global, governos, indústria e sociedade civil - a primeira vez que o evento, organizado pela International AIDS Society (IAS), acontece na América do Sul. O encontro teve apoio do Ministério da Saúde e da Fiocruz.\n\nEntre os temas centrais dos debates estiveram os avanços nas pesquisas por uma cura e por novas formas de profilaxia, o acesso equitativo a tecnologias em saúde, a crise global de financiamento da resposta ao HIV, a redução de preços de medicamentos e o enfrentamento ao estigma. A presidente da IAS, Beatriz Grinsztejn, expressou otimismo quanto ao avanço científico, enquanto o diretor-geral da OMS, Tedros Adhanom, reforçou que a luta contra o HIV "não é uma batalha encerrada" e cobrou prioridade e financiamento sustentado para a resposta global.\n\nO Brasil foi apresentado como referência internacional em prevenção, diagnóstico e tratamento do HIV. Durante o evento, o ministro da Saúde, Alexandre Padilha, anunciou que uma nova tecnologia de PrEP injetável de longa duração, aplicada a cada dois meses, foi submetida à comissão de incorporação de tecnologias do SUS para avaliação em agosto. A Fiocruz também firmou acordo com a farmacêutica MSD Brasil para explorar a colaboração em torno do MK-8527, um medicamento injetável de longa duração ainda em fase de pesquisa para PrEP contra o HIV.',
    sourceName: 'Fiocruz',
