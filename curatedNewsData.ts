...
export const curatedNews: CuratedNewsItem[] = [
  {
    id: 'fiocruz-proteina-diagnostico-leishmaniose-visceral-2026',
    title: 'Fiocruz desenvolve nova proteína para ampliar o diagnóstico da leishmaniose visceral em humanos e cães',
    summary: 'Pesquisadores da Fiocruz Pernambuco, liderados por Osvaldo Pompílio, submeteram ao Instituto Nacional da Propriedade Industrial (INPI) o pedido de patente de uma nova proteína quimérica para o diagnóstico da leishmaniose visceral, doença transmitida pelo mosquito-palha e endêmica em diversas regiões do Brasil, incluindo áreas do Centro-Oeste. A novidade evolui a proteína Q5, já patenteada nos Estados Unidos, e tem a vantagem de funcionar tanto em testes rápidos quanto em ensaios laboratoriais mais sensíveis (Elisa), além de detectar a infecção tanto em humanos quanto em cães - importantes reservatórios da doença. Fortalecer o diagnóstico precoce é fundamental, já que a leishmaniose visceral pode ser grave e até fatal quando não tratada a tempo.',
    sourceName: 'Fiocruz',
    sourceUrl: 'https://fiocruz.br/noticia/2026/08/pedido-de-patente-de-proteina-aplicada-ao-diagnostico-de-leishmaniose-visceral-e',
    publishedOn: '2026-08-25',
  },
  {
    id: 'agenciagov-cuidados-rins-sinais-alerta-2026',
    title: 'Rins em silêncio: especialistas explicam como identificar sinais de alerta e prevenir complicações renais',
    summary: 'Doenças renais costumam evoluir de forma silenciosa, sem sintomas evidentes até estágios mais avançados. Segundo especialistas do Hospital Universitário de Lagarto (HUL-UFS) ouvidos pela Agência Gov, sinais de alerta incluem inchaço persistente em pernas, pés, mãos ou ao redor dos olhos, alterações na urina (espuma excessiva, cor escura ou sangue), fadiga, náuseas e dificuldade para controlar a pressão arterial. A prevenção passa por hidratação adequada, controle rigoroso de diabetes e hipertensão - os principais fatores de risco -, uso cauteloso de anti-inflamatórios e analgésicos, e realização periódica de exames de creatinina e urina. Identificar a doença renal crônica precocemente ajuda a preservar a função dos rins e reduzir complicações cardiovasculares.',
    sourceName: 'Agência Gov (EBC)',
    sourceUrl: 'https://agenciagov.ebc.com.br/noticias/202608/cuidados-com-os-rins-especialistas-do-hu-brasil-explicam-como-identificar-sinais-de-alerta-e-prevenir-complicacoes-renais',
    publishedOn: '2026-08-25',
  },
  {
