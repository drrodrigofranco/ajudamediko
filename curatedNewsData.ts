    ...
    references: [
      {
        ...
        url: 'https://doi.org/10.1002/uog.29181',
      },
      {
        label: 'Lees CC, Stampalija T, Baschat A, da Silva Costa F, Ferrazzi E, Figueras F, Hecher K, Kingdom J, Poon LC, Salomon LJ, Unterscheider J. ISUOG Practice Guidelines: diagnosis and management of small-for-gestational-age fetus and fetal growth restriction. Ultrasound Obstet Gynecol. 2020;56(2):298-312.',
        url: 'https://doi.org/10.1002/uog.22134',
      },
      {
        label: 'Kale PL, Fonseca SC. Intrauterine growth restriction, prematurity, and low birth weight: risk phenotypes of neonatal death, Rio de Janeiro State, Brazil. Cad Saude Publica. 2023;39(6):e00231022.',
