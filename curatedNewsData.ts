...
export const curatedNews: CuratedNewsItem[] = [
  ...
  {
    id: 'ibge-ms-pesquisa-nacional-saude-2026',
    title: 'IBGE e Ministério da Saúde lançam a Pesquisa Nacional de Saúde 2026, com coleta de biomarcadores',
    summary: 'O IBGE e o Ministério da Saúde deram início, em julho, à terceira edição da Pesquisa Nacional de Saúde (PNS), levantamento domiciliar que vai visitar mais de 140 mil residências em todo o país para mapear hábitos de vida, acesso a serviços de saúde, doenças crônicas e a saúde da população idosa. A novidade desta edição é a coleta de biomarcadores em pessoas acima de 35 anos - exames de sangue e urina que vão medir indicadores como colesterol, hemoglobina glicada e sorologia para chikungunya, entre outros. Os resultados devem orientar políticas públicas e o planejamento do SUS nos próximos anos.',
    sourceName: 'Agência Brasil (EBC)',
    sourceUrl: 'https://agenciabrasil.ebc.com.br/saude/noticia/2026-07/pesquisa-nacional-do-ibge-quer-saber-como-anda-saude-do-brasileiro',
