...
export const curatedNews: CuratedNewsItem[] = [
  {
    id: 'opas-hearts-2-hipertensao-doencas-cronicas-2026',
    title: 'OPAS e Ministério da Saúde avançam com a iniciativa HEARTS 2.0 para integrar o cuidado de hipertensão e outras doenças crônicas no Brasil',
    summary: 'Ao longo da segunda semana de agosto de 2026, a Organização Pan-Americana da Saúde (OPAS/OMS) promoveu uma série de encontros no Brasil para acelerar a implementação da iniciativa HEARTS 2.0, estratégia da Organização Mundial da Saúde voltada à prevenção, ao diagnóstico, ao tratamento e ao controle das doenças cardiovasculares. Em 10 e 11 de agosto, equipes da OPAS realizaram visitas técnicas e reuniões de trabalho em São Paulo e no Rio de Janeiro, reunindo o Ministério da Saúde, secretarias estaduais e municipais de Saúde, a Sociedade Brasileira de Cardiologia, o Hospital Israelita Albert Einstein, o Instituto Nacional de Cardiologia e equipes de Unidades Básicas de Saúde.\n\nA versão 2.0 da iniciativa amplia o escopo original do HEARTS ao propor um cuidado integrado não apenas da hipertensão arterial, mas também de diabetes, doença renal crônica, dislipidemias e risco cardiovascular como um todo, articulando ações de promoção da saúde, prevenção, diagnóstico e acompanhamento contínuo dos pacientes dentro da Atenção Primária à Saúde.\n\nDois dias depois, entre 12 e 14 de agosto, mais de 30 instituições - entre elas o Conselho Nacional de Secretários de Saúde (Conass), o Conselho Nacional de Secretarias Municipais de Saúde (Conasems), o próprio Ministério da Saúde, a OPAS/OMS, o Instituto Nacional de Cardiologia e a Sociedade Brasileira de Cardiologia - se reuniram na sede da OPAS em Brasília para discutir os próximos passos da estratégia. Segundo o Conass, os encontros reforçaram que o Brasil já dispõe de boa parte da infraestrutura necessária para transformar a prevenção e o cuidado das condições crônicas não transmissíveis, mas ainda precisa avançar em integração entre os serviços, qualidade do acompanhamento e implementação efetiva na ponta. Como próximos passos, foram definidos: levar a implementação do HEARTS à agenda do Grupo de Trabalho Tripartite do SUS, envolver câmaras técnicas na construção da estratégia, integrá-la às Redes de Atenção à Saúde já existentes e criar uma Rede Brasileira permanente de colaboração entre as instituições envolvidas.\n\nHipertensão arterial, diabetes e doença renal crônica estão entre as principais causas evitáveis de infarto, AVC e insuficiência cardíaca quando não diagnosticadas e acompanhadas a tempo - e boa parte desse acompanhamento depende de exames relativamente simples e acessíveis, como a aferição regular da pressão arterial, o eletrocardiograma e a monitorização ambulatorial da pressão ao longo de 24 horas (MAPA). Iniciativas como o HEARTS 2.0 reforçam, na prática, algo que já orienta nosso trabalho na Clínica Franco: quanto mais cedo um risco cardiovascular é identificado, maior a chance de evitar suas complicações mais graves. Aqui em Nova Andradina, oferecemos MAPA 24h, Holter 24h, eletrocardiograma e ultrassom de carótidas e vertebrais como parte da avaliação de risco cardiovascular.\n\nOs detalhes completos sobre os encontros de agosto e os próximos passos da iniciativa HEARTS 2.0 no Brasil estão nas referências abaixo, com links diretos para as publicações da OPAS/OMS e do Conass.',
    sourceName: 'OPAS/OMS (Organização Pan-Americana da Saúde)',
    sourceUrl: 'https://www.paho.org/pt/noticias/11-8-2026-opas-e-parceiros-avancam-na-implementacao-das-iniciativas-hearts-e-melhor',
    publishedOn: '2026-08-19',
    references: [
      {
        label: 'OPAS/OMS. OPAS e parceiros avançam na implementação das iniciativas HEARTS e Melhor Atenção às DCNTs no Brasil. 11 de agosto de 2026.',
        url: 'https://www.paho.org/pt/noticias/11-8-2026-opas-e-parceiros-avancam-na-implementacao-das-iniciativas-hearts-e-melhor',
      },
      {
        label: 'Conass. Conass participa de discussões para fortalecer a implementação da iniciativa HEARTS no Brasil.',
        url: 'https://www.conass.org.br/conass-participa-de-discussoes-para-fortalecer-a-implementacao-da-iniciativa-hearts-no-brasil/',
      },
    ],
  },
  {
